...
import { useAdminCreateTask } from "@/_hooks/useTasks";
...
export default function AdminTaskCreate() {
  ...
  const createTaskMutation = useAdminCreateTask();
  ...
  // Filter Course
  const filteredCourses = selectedUserId
    ? courses.filter((c) => String(c.user_id) === String(selectedUserId))
    : [];
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <UserInput
              ...
              as="select"
              required
              {...register("course_id", { required: "Mata kuliah wajib dipilih" })}
